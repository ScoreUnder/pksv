...
unsigned int Do(unsigned int proc) {
  ...
  while (i < 1024) {
    if (doprocs[i] == 0) {
      j = 0;
      while (j < 2048) {
        if (doneprocs[j] == proc) return proc;
        j++;
      }
      doprocs[i] = proc;
      break;
...
unsigned int DoText(unsigned int proc) {
  ...
  while (i < 1024) {
    if (dotexts[i] == 0) {
      j = 0;
      while (j < 2048) {
        if (donetexts[j] == proc) return proc;
        j++;
      }
      dotexts[i] = proc;
      break;
...
unsigned int DoMove(unsigned int proc) {
  ...
  while (i < 1024) {
    if (domoves[i] == 0) {
      j = 0;
      while (j < 2048) {
        if (donemoves[j] == proc) return proc;
        j++;
      }
      domoves[i] = proc;
      break;
...
unsigned int DoMart(unsigned int proc) {
  ...
  while (i < 1024) {
    if (domarts[i] == 0) {
      j = 0;
      while (j < 2048) {
        if (donemarts[j] == proc) return proc;
        j++;
      }
      domarts[i] = proc;
      break;
...
unsigned int DoThumb(unsigned int proc) {
  ...
  while (i < 1024) {
    if (dothumb[i] == 0) {
      j = 0;
      while (j < 2048) {
        if (donethumb[j] == proc) return proc;
        j++;
      }
      dothumb[i] = proc;
      break;
...
unsigned int DoDword(unsigned int proc) {
  ...
  while (i < 1024) {
    if (dodword[i] == 0) {
      j = 0;
      while (j < 2048) {
        if (donedword[j] == proc) return proc;
        j++;
      }
      dodword[i] = proc;
      break;
...
unsigned int DoLevel(unsigned int proc) {
  ...
  while (i < 1024) {
    if (dolevel[i] == 0) {
      j = 0;
      while (j < 2048) {
        if (donelevel[j] == proc) return proc;
        j++;
      }
      dolevel[i] = proc;
      break;
