...
struct parse_result default_format_hex(uint32_t value, bool is_dyndec, struct decompiler_informative_state *state) {
  (void) is_dyndec;
  (void) state;
...
struct parse_result default_format_dec(uint32_t value, bool is_dyndec, struct decompiler_informative_state *state) {
  (void) is_dyndec;
  (void) state;
