...
{
    unsigned int still_going,arg1,arg2,arg3,arg4,arg5,arg6,arg7,endat,failsafe=0;
               ...
               )
{
    ...
    while (!AllDone())
    {
        DecodeProc2(fileM,narc,Done(FindNotDone()),fname
#ifndef DLL
                    ,fsend
#endif
                   );
...
#define nl() fprintf(fsend,"\r\n")
    while (!AllDoneText())
    {
        ...
        if (mode!=GOLD)
            ...
            fprintf(fsend,"#org 0x%X\r\n%s",arg1,transtxt(arg1&0x07ffffff,fname));
    }
    while (!AllDoneMove())
    {
        nl();
