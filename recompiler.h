    ...
    while(i<strlen(Script))
    {
      switch(chr) //Behave differently according to char
      {
        ...
        default:
          ...
          aa("loadfont")            {BASIC(GLD_LOADFONT);            ec();}
          aa("loadmovesprites")     {BASIC(GLD_LOADMOVESPRITES);     ec();}
          aa("release")             {BASIC(GLD_LOADMOVESPRITES);     ec();}
          ...
          aa("text-newline")        {BASIC(5);                       ec();}
          aa("text-waitbutton")     {BASIC(6);                       ec();}
          aa("text-newlinewitharrow"){BASIC(7);                      ec();}
          aa("text-switchtoasm")    {BASIC(8);                       ec();}
          aa("text-interpretdata")  {BASIC(10);                      ec();}
          aa("text-playsound0")     {BASIC(11);                      ec();}
          aa("text-waitbutton2")    {BASIC(13);                      ec();}
          aa("text-playsound9")     {BASIC(14);                      ec();}
          aa("text-playsound1")     {BASIC(15);                      ec();}
          aa("text-playsound2")     {BASIC(16);                      ec();}
          aa("text-playsounda")     {BASIC(17);                      ec();}
          aa("text-playsoundd")     {BASIC(18);                      ec();}
          aa("text-playsoundc")     {BASIC(19);                      ec();}
          aa("text-day")            {BASIC(21);                      ec();}
          aa("2call")
          {
            vlog("2CALL\r\n");
            arg1=GetNum("2CALL");
          ...
          aa("text-hex")
          {
            ...
            buf[j]=0;
            if(!strcmp(buf,"money-no-zeros")){arg2|=(7<<5);}
            else if(!strcmp(buf,"no-zeros")){arg2|=(6<<5);}
            else if(!strcmp(buf,"money-spaces")){arg2|=(5<<5);}
            else if(!strcmp(buf,"spaces")){arg2|=(4<<5);}
            else if(!strcmp(buf,"money2")){arg2|=(3<<5);}
            else if(!strcmp(buf,"normal2")){arg2|=(2<<5);}
            else if(!strcmp(buf,"money")){arg2|=(1<<5);}
            else if(!strcmp(buf,"normal")){arg2|=(0<<5);}
            else
            {
